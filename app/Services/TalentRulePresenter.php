...
final class TalentRulePresenter
{
    ...
    private const OPERATIONS = [
        ...
        'ad_view_reward' => ['readiness' => 'WSTRZYMANE · DOWÓD OBEJRZENIA', 'trigger' => 'Wymaga mierzalnego czasu ekspozycji, budżetu i antyfraudu.', 'locked' => true],
        'ad_click_reward' => ['readiness' => 'WSTRZYMANE · ANTYFRAUD', 'trigger' => 'Wymaga potwierdzonego celu kampanii, budżetu i zabezpieczenia farm kliknięć.', 'locked' => true],
