...
final class ActivityUiHelper
{
    ...
    private const EVENT_MAP = [
        ...
        'app_referral_bonus' => ['suffix' => 'app_referral', 'icon' => 'share'],
        ...
        'response_publication_bonus' => ['suffix' => 'response_publication', 'icon' => 'article'],
        'response_submission_deposit_hold' => ['suffix' => 'response_deposit_hold', 'icon' => 'wallet'],
        'response_submission_deposit_refund' => ['suffix' => 'response_deposit_refund', 'icon' => 'wallet'],
        'response_submission_deposit_forfeit' => ['suffix' => 'response_deposit_forfeit', 'icon' => 'warning'],
        'response_submission_deposit_forfeit_reversal' => ['suffix' => 'response_deposit_forfeit_reversal', 'icon' => 'wallet'],
        ...
        'article_charge' => ['suffix' => 'article_charge', 'icon' => 'article'],
        'article_sale_author_share' => ['suffix' => 'article_sale_author_share', 'icon' => 'article'],
        'article_sale_platform_share' => ['suffix' => 'article_sale_platform_share', 'icon' => 'finance'],
        'article_sale_safety_fund_share' => ['suffix' => 'article_sale_safety_fund_share', 'icon' => 'shield'],
        'safety_fund_disbursement' => ['suffix' => 'safety_fund_disbursement', 'icon' => 'shield'],
